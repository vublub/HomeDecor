...
public class ShopPage extends AppCompatActivity {
    ...
    public void onClick(View view){
        ...
        if (id == R.id.returntosignin){
            ...
            Intent intent = new Intent(ShopPage.this, Kitchen.class);
            startActivity(intent);
        } else if (id == R.id.livingRoom) {
            Intent intent = new Intent(ShopPage.this, LivingRoom.class);
            startActivity(intent);
        } else if (id == R.id.bedroom) {
            Intent intent = new Intent(ShopPage.this, Bedroom.class);
            startActivity(intent);
        } else if (id == R.id.bathroom) {
            Intent intent = new Intent(ShopPage.this, Bathroom.class);
            startActivity(intent);
        } else if (id == R.id.office) {
            Intent intent = new Intent(ShopPage.this, Office.class);
            startActivity(intent);
        } else if (id == R.id.diningRoom) {
            Intent intent = new Intent(ShopPage.this, DiningRoom.class);
            startActivity(intent);
        } else if (id == R.id.decor) {
            Intent intent = new Intent(ShopPage.this, Decor.class);
            startActivity(intent);
