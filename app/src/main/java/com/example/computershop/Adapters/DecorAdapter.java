...
public class DecorAdapter extends RecyclerView.Adapter<DecorAdapter.ViewHolder>{

    private Context context;
    private List<Product> productList;
    public DecorAdapter(Context context, List<Product> productList){
        this.context = context;
        this.productList = productList;}

    @NonNull
    @Override
    public DecorAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_shop_page, parent, false);
        return new DecorAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DecorAdapter.ViewHolder holder, int position) {
