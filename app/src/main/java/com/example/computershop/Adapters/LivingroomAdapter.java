...
public class LivingroomAdapter extends RecyclerView.Adapter<LivingroomAdapter.ViewHolder>{
    ...
    public LivingroomAdapter(Context context, List<Product> productList){
    ...
    @NonNull
    @Override
    public LivingroomAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_shop_page, parent, false);
        return new LivingroomAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LivingroomAdapter.ViewHolder holder, int position) {
