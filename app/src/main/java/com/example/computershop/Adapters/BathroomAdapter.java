...
public class BathroomAdapter extends RecyclerView.Adapter<BathroomAdapter.ViewHolder>{
    ...
    public BathroomAdapter(Context context, List<Product> productList){
        this.context = context;
        this.productList = productList;}
    @NonNull
    @Override
    public BathroomAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_shop_page, parent, false);
        return new BathroomAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BathroomAdapter.ViewHolder holder, int position) {
