...
public class OfficeAdapter extends RecyclerView.Adapter<OfficeAdapter.ViewHolder>{
    ...
    public OfficeAdapter(Context context, List<Product> productList){
    ...
    public OfficeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new OfficeAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OfficeAdapter.ViewHolder holder, int position) {
