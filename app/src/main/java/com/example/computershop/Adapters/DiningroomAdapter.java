...
import com.example.computershop.DiningRoom;
import com.example.computershop.Models.Product;
import com.example.computershop.R;

import java.util.List;

public class DiningroomAdapter extends RecyclerView.Adapter<DiningroomAdapter.ViewHolder>{
    private Context context;
    private List<Product> productList;
    public DiningroomAdapter(Context context, List<Product> productList){
        this.context = context;
        this.productList = productList;}

    @NonNull
    @Override
    public DiningroomAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_shop_page, parent, false);
        return new DiningroomAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DiningroomAdapter.ViewHolder holder, int position) {
